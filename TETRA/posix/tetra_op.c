...
volatile Word32 Overflow_count = 0;
#endif
...
Word32 L_add_overflow_test(Word32 L_var1, Word32 L_var2, Word16* p_overflow) 
{
   Word32 L_var_out;
...
Word32 L_mac0_overflow_test(Word32 L_var3, Word16 var1, Word16 var2, Word16* p_overflow) 
{
   ...
   L_produit = L_mult0(var1,var2);
   L_var_out = L_add_overflow_test(L_var3,L_produit,p_overflow);
   return(L_var_out);
}
/************************************************************************
*
...
Word16 mult_r(Word16 var1, Word16 var2)
  {
   ...
   L_produit_arr += (Word32) 0x00004000;        /* r_ound */
...
*		bit number:
*			r_ound(L_var1) = extract_h(L_add(L_var1,32768))
*
*	Complexity Weight : 1
*
*	Inputs :
