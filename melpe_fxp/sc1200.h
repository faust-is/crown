...
BOOLEAN low_rate_chn_read(void* melpe_handle, struct quant_param *qpar, struct melp_param *par,
			  struct melp_param *prev_par);

void fec_code(void* fec_code_handle, struct quant_param *par);

int16_t fec_decode(void* fec_code_handle, struct quant_param *par, int16_t erase);
