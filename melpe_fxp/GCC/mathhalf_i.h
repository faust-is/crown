...
{
	if (unlikely(L_var1 > SW_MAX)) return SW_MAX;
	if (unlikely(L_var1 < SW_MIN)) return SW_MIN;
...
{
	return (int16_t) (0x0000ffffL & L_var1);
}
...
{
	return (int16_t) (0x0000ffffL & (L_var1 >> 16));
}
...
{
	return melpe_extract_h(melpe_L_add(L_var1, 0x00008000L));	/* r_ound MSP */
}
...
{
	int64_t acc = (int64_t) L_var1 + L_var2;
	if (unlikely(acc > LW_MAX)) acc = LW_MAX;
	if (unlikely(acc < LW_MIN)) acc = LW_MIN;
	return (int32_t) acc;
}
...
static inline int16_t S_shl_s_positive(int16_t var1, int16_t var2)
{
	int16_t swOut;
	int32_t L_Out;
	...
	if (var2 == 0 || var1 == 0) {
		...
		if (likely(var2 < 15)) {
			...
			swOut = (int16_t) ((var1 > 0) ? SW_MAX : SW_MIN); /* saturate */
		}
	}
	return (swOut);
}
...
static inline int16_t S_shr_s_positive(int16_t var1, int16_t var2)
{
...
/* shift left with saturation: Qx->Q(x-t)        */
static inline int32_t L_shl_l_positive(int32_t L_var1, int16_t var2)
{
	int32_t L_Out;
	int64_t ACC;
	if (var2 == 0 || L_var1 == 0) {
...
/* shift right with saturation: Qx->Q(x-t)        */
static inline int32_t L_shr_l_positive(int32_t L_var1, int16_t var2)
{
	if (likely(var2 < 31)) return L_var1 >> var2;
	return ((L_var1 > 0) ? 0 : 0xffffffffL);
}
 ...
 *
 *************************************************************************/
static inline int16_t melpe_normalize(int32_t L_var1) {
	/* return 31 on L_var = 0, eq DSP instruction _norm() */
	if (L_var1 < 0) L_var1 = ~L_var1;
	return L_var1 ? __builtin_clz(L_var1) - 1 : 31;
}

static inline int16_t melpe_norm_l(int32_t L_var1)
{
	/* return 0 on L_var = 0 */
	if (unlikely(L_var1 == 0)) return 0; else
	return melpe_normalize(L_var1);
}
...
{
	if (unlikely(var1 == 0)) return 0; else
	return melpe_normalize(var1) - 16;
}
...
static inline int32_t melpe_L_mult(int16_t var1, int16_t var2)
{
	...
	if (unlikely(var1 == SW_MIN && var2 == SW_MIN)) {	/* overflow */
		return LW_MAX;
	} else {
...
{
	return melpe_extract_h(melpe_L_mult(var1, var2));
}
...
{
	return melpe_L_add(L_var3, melpe_L_mult(var1, var2));
}
...
{
	return melpe_L_sub(L_var3, melpe_L_mult(var1, var2));
}
...
{
	return melpe_r_ound(melpe_L_sub(L_var3, melpe_L_mult(var1, var2)));
}
...
static inline int16_t melpe_abs_s(int16_t var1)
{
	...
	if (unlikely(var1 == SW_MIN))
		...
		if (var1 < 0) swOut = melpe_negate(var1);
		else swOut = var1;
	}
	return (swOut);
}
...
static inline int64_t melpe_L40_sat(int64_t acc) {
	if (unlikely(acc > MAX_40)) return MAX_40;
	if (unlikely(acc < MIN_40)) return MIN_40;
	return acc;
}
...
{
	if (var1 > 0) return melpe_L40_sat(acc << var1); else
	if (var1 < 0) return acc >> (-var1); else
	return acc;
}
...
{
	if (unlikely(acc == 0)) return 0; else
	if ((acc > 255) || (acc < -255)) return melpe_normalize(acc >> 8) - 8;
	else return melpe_normalize((int32_t) acc);
}
...
{
	if (unlikely(acc > (int64_t) MAX_32)) {
		return MAX_32;
	}
	if (unlikely(acc < (int64_t) MIN_32)) {
		return MIN_32;
	}
	return (int32_t) acc;
}
